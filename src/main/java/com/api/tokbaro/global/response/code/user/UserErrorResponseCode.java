...
public enum UserErrorResponseCode implements BaseResponseCode {
    ...
    DUPLICATE_EMAIL_409("DUPLICATE_EMAIL_409", 409, "사용자 이메일이 이미 존재합니다."),
    DUPLICATE_USERNAME_409("DUPLICATE_USERNAME_409", 409, "사용자 이름이 이미 존재합니다."),
    DUPLICATE_NICKNAME_409("DUPLICATE_NICKNAME_409", 409, "사용자 닉네임이 이미 존재합니다."),
    ...
    INVALID_REFRESH_TOKEN_401("INVALID_REFRESH_TOKEN_401", 401, "리프레쉬 토큰이 유효하지 않습니다."),
    USER_NOT_FOUND_FOR_TOKEN_404("USER_NOT_FOUND_FOR_TOKEN_404", 404, "토큰에 해당하는 사용자를 찾을 수 없습니다."),
    CONTENT_DATA_NOT_FOUND_404("CONTENT_DATA_NOT_FOUND_404", 404, "유저의 콘텐츠데이터가 존재하지 않습니다.");
